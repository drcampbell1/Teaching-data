...
In this module, you'll learn how to analyse data and extract meaninful insights from it. The module introduces students to the programming language, R, using a powerful set of tools known as the Tidyverse. You’ll get a taste of the value of exploratory data analysis and the power of the Tidyverse tools. You'll begin by using the *readr* package to bring data into RStudio and examine its properties and structure. You'll then use the *dplyr* package and learn to use the group by and summarise verbs, which collapse large datasets into manageable summaries. Taking this further, you'll  learn how to filter, sort and arrange your summaries to deepen your insights. You'll create informative bar plots, histograms and line plots, and customise them with the *ggplot2* package, optimising the aesthetics and geoms to help you build insightful and accurate visualisations. From here you’ll progress your ggplot2 skills and learn how to calculate statistics and use facets and coordinate using some best practices. Most importantly, though, as you progress in the module, you'll see how these tools may be used together.
